          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="view/all_product.php"> Products </a>
                </li>
                <li class="nav-item">
              ...
              <form action="../view/product_search_result.php" method="GET">
                <input type="text" placeholder="Search.." name="find" disabled>
              <!-- <form class="form-inline my-2 my-lg-0 ml-0 ml-lg-4 mb-3 mb-lg-0"> -->
                <button class="btn  my-2 my-sm-0 nav_search-btn" type="submit" name ="send" disabled></button>
              </form>
            </div>
  ...
  <section class="service_section layout_padding ">
    <div class="container">
      ...
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="./images/FoW_oranges.jpeg" alt="Card image cap" />
            <div class="card-body">
              
            </div>
          </div>
          <div class="card">
            <img class="card-img-top" src="./images/FoW_grapes.jpeg" alt="Card image cap" />
            <div class="card-body">
             
            </div>
          </div>
          <div class="card">
            <img class="card-img-top" src="./images/FoW_mangoes.jpeg" alt="Card image cap" />
            <div class="card-body">
...
if (isset($_SESSION['userRole']))
{
  $admin=check_user_role();
    if($admin == 1)
    {
      echo"<script>document.getElementById('Brand_Add').style.display='block'; </script>";
    }
}
