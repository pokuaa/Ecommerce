            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.php"><img src="../images/FoW_logo.jpeg" alt="Logo" srcset=""></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <button class="btn btn-primary me-1 mb-1" data-bs-toggle="modal" data-bs-target="#inlineForm">Add Product</button>
                            </nav>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <tbody>
                            <?php
                                ...
                                // gets product details update the table
                                $product_list=get_all_product_ctr();
                                foreach ($product_list as $aproduct) {
                                    $productcat= implode(fetch_category_name($aproduct['product_cat']));
                                    $productbrand= implode(fetch_brand_name($aproduct['product_brand']));

                                    $productid=$aproduct['product_id'];
                                    $productimage=$aproduct['product_image'];
                                    // $productcat=$aproduct['product_cat'];
                                    // $productbrand=$aproduct['product_brand'];
                                    $producttitle=$aproduct['product_title'];
                                    $productprice=$aproduct['product_price'];
                                    $productdesc=$aproduct['product_desc'];
                                    $productkeyword=$aproduct['product_keywords'];
                                    ...
                                    echo"
                                        ...
                                        <tr>
                                            ...
                                            <td><img src='$productimage' width='60' height='60'/></td>
                                            <td>$productcat</td>
                                            <td>$productbrand</td>
                                            <td>$producttitle</td>
                                            <td>$productprice</td>
                                     ...
                                     <button><a href='productEdit.php?product=$productid'>Update</a></button>
                                     <button><a href='../actions/Add_product.php?delete=$productid'>Delete</a></button>
                                </td>
                            </tr>";
                    }
                ?>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="../actions/Add_product.php" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" name="cat_name">
                                        <?php getCategoriesDropDown() ?>
                                    </div>
                                    <label>Product Brand: </label>
                                    <div class="form-group" name="brand_name">
                                        <?php getBrandsDropDown() ?>
                                    </div>
                                    <label>Product title: </label>
                                    <div class="form-group">
                                        <input type="text" placeholder="Product title" class="form-control" name="prod_title" required>
                                    </div>
                                    <label>Product price: </label>
                                    <div class="form-group">
                                        <input type="number" placeholder="Product price" class="form-control" name="prod_price" required>
                                    </div>
                                    <label>Product description: </label>
                                    <div class="form-group">
                                        <textarea col="4" class="form-control" name="description"></textarea>

                                    </div>
                                    <label>Product keywords: </label>
                                    <div class="form-group">
                                        <input type="text" placeholder="Product keywords" class="form-control" name="keyword" required>
                                    </div>
